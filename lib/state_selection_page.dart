...
loc.state_WestBengal,
    ...
    return Scaffold(
      appBar: AppBar(title: Text(loc.selectState)), // localized
      body: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(loc.fromWhichState, style: TextStyle(fontSize: 18)), // localized
            SizedBox(height: 20),
            DropdownSearch<String>(
              ...
              dropdownDecoratorProps: DropDownDecoratorProps(
                dropdownSearchDecoration: InputDecoration(
                  hintText: loc.selectYourState, // localized
